...
export const STR: Record<Lang, Strings> = {
  en: {
    ...
    dirIn: 'In', dirInternal: 'LAN', minBytes: 'Min bytes', all: 'All', cables: 'Submarine cables', routes: 'Real path (mtr)',
    ...
    bandwidth: 'Throughput · last', dstCountries: 'Dst countries (5 min)', appsPanel: 'Apps (SNI · 5 min)',
    topDst: 'Top destinations', topSrc: 'Top sources (LAN)', topPort: 'Top ports', unmatchedPanel: 'Unclassified SNI (add rules)',
    timeline: 'Throughput · drag to replay a window', statsPanel: 'Stats',
  },
  zh: {
    ...
    minBytes: '最小流量', all: '全部', cables: '海底光缆', routes: '真实路径 (mtr)', placeLabels: '地名标注',
    ...
    showing: '显示中', cableRouted: '光缆路由', total: '累计', bandwidth: '实时吞吐 · 近', dstCountries: '目的国 (5分钟)',
    appsPanel: '应用 (SNI · 5分钟)', topDst: 'Top 目的地', topSrc: 'Top 源主机 (内网)', topPort: 'Top 端口',
    unmatchedPanel: '待补规则 · 未分类 SNI', timeline: '吞吐时间轴 · 拖拽回放某段', statsPanel: '流量统计',
  },
  'zh-Hant': {
    ...
    minBytes: '最小流量', all: '全部', cables: '海底電纜', routes: '真實路徑 (mtr)', placeLabels: '地名標註',
    ...
    showing: '顯示中', cableRouted: '電纜路由', total: '累計', bandwidth: '即時吞吐 · 近', dstCountries: '目的國 (5分鐘)',
    appsPanel: '應用 (SNI · 5分鐘)', topDst: 'Top 目的地', topSrc: 'Top 來源主機 (內網)', topPort: 'Top 連接埠',
    unmatchedPanel: '待補規則 · 未分類 SNI', timeline: '吞吐時間軸 · 拖曳重播某段', statsPanel: '流量統計',
  },
  ja: {
    ...
    minBytes: '最小バイト', all: '全て', cables: '海底ケーブル', routes: '実経路 (mtr)', placeLabels: '地名ラベル',
    ...
    bandwidth: 'スループット · 直近', dstCountries: '宛先国 (5分)', appsPanel: 'アプリ (SNI · 5分)', topDst: '上位宛先',
  ...
  ko: {
    ...
    all: '전체', cables: '해저 케이블', routes: '실제 경로 (mtr)', placeLabels: '지명 라벨', colorByApp: '앱별 색상 (SNI)',
    ...
    cableRouted: '케이블 경유', total: '누적', bandwidth: '처리량 · 최근', dstCountries: '목적지 국가 (5분)',
    appsPanel: '앱 (SNI · 5분)', topDst: '상위 목적지', topSrc: '상위 출발지 (LAN)', topPort: '상위 포트',
  ...
  ru: {
    ...
    dirIn: 'Вх', dirInternal: 'LAN', minBytes: 'Мин. байт', all: 'Все', cables: 'Подводные кабели', routes: 'Реальный путь (mtr)',
    ...
    total: 'Всего', bandwidth: 'Пропускная · за', dstCountries: 'Страны назн. (5 мин)', appsPanel: 'Прил. (SNI · 5 мин)',
  ...
  es: {
    ...
    dirIn: 'Entrada', dirInternal: 'LAN', minBytes: 'Bytes mín', all: 'Todo', cables: 'Cables submarinos', routes: 'Ruta real (mtr)',
    ...
    total: 'Total', bandwidth: 'Rendimiento · últ', dstCountries: 'Países destino (5 min)', appsPanel: 'Apps (SNI · 5 min)',
  ...
  fr: {
    ...
    dirIn: 'Entrant', dirInternal: 'LAN', minBytes: 'Octets min', all: 'Tout', cables: 'Câbles sous-marins',
    ...
    showing: 'Affichage', cableRouted: 'Via câble', total: 'Total', bandwidth: 'Débit · dern', dstCountries: 'Pays dest. (5 min)',
    appsPanel: 'Apps (SNI · 5 min)', topDst: 'Top destinations', topSrc: 'Top sources (LAN)', topPort: 'Top ports',
  ...
  de: {
    ...
    dirInternal: 'LAN', minBytes: 'Min. Bytes', all: 'Alle', cables: 'Seekabel', routes: 'Echter Pfad (mtr)',
    ...
    dstCountries: 'Ziel-Länder (5 Min)', appsPanel: 'Apps (SNI · 5 Min)', topDst: 'Top Ziele', topSrc: 'Top Quellen (LAN)',
  ...
  ar: {
    ...
    dirInternal: 'LAN', minBytes: 'أدنى بايت', all: 'الكل', cables: 'كابلات بحرية', routes: 'المسار الفعلي (mtr)',
    ...
    bandwidth: 'الإنتاجية · آخر', dstCountries: 'دول الوجهة (5 د)', appsPanel: 'التطبيقات (SNI · 5 د)', topDst: 'أهم الوجهات',
  ...
  pt: {
    ...
    dirIn: 'Entrada', dirInternal: 'LAN', minBytes: 'Bytes mín', all: 'Tudo', cables: 'Cabos submarinos', routes: 'Rota real (mtr)',
    ...
    total: 'Total', bandwidth: 'Vazão · últ', dstCountries: 'Países destino (5 min)', appsPanel: 'Apps (SNI · 5 min)',
  ...
  it: {
    ...
    dirIn: 'Entrata', dirInternal: 'LAN', minBytes: 'Byte min', all: 'Tutto', cables: 'Cavi sottomarini',
    ...
    dstCountries: 'Paesi dest. (5 min)', appsPanel: 'App (SNI · 5 min)', topDst: 'Top destinazioni', topSrc: 'Top sorgenti (LAN)',
